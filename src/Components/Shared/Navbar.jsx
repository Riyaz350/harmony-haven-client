...
const Navbar = () => {
    ...
    const inActive = 'btn shadow-none bg-transparent border-2 border-transparent text-black lg:w-auto w-full hover:border-[#00a9a5] border-transparent rounded-lg hover:bg-[#00a9a5] hover:border-[#ffffff] hover:text-[#ffffff]'
