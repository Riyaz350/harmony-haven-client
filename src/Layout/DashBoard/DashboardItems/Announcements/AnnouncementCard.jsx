...
const AnnouncementCard = ({announcement}) => {
    ...
    return (
        <div>
            ...
            <button className="btn w-full bg-yellow-300 hover:bg-[#00a9a5] hover:text-white font-bold" onClick={()=>document.getElementById(_id).showModal()}>{title}   ({submissionTime})</button>
